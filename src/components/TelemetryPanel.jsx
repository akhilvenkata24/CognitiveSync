      ...
      <div className={`panel-card ${!detected ? 'suppressed' : ''} ${attentionLevel >= 2 ? 'level2-dimmed' : ''}`}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
          ...
          <div>
            ...
            <div className="telemetry-row">
              <span className="telemetry-label">Dynamic Blink Rate</span>
              <span className="telemetry-val" style={{ color: ear < 0.18 ? 'var(--color-fatigued)' : 'var(--hud-accent)' }}>
                {ear < 0.18 ? 'BLINKING' : 'OPEN'}
              </span>
            </div>
            <div className="telemetry-row">
